...
To build the final jar and optimize the AccountValidation application for production, run:
...
Then navigate to [http://localhost:90025](http://localhost:90025) in your browser.
